...
function renderContent(notification: NotificationItemProps) {
    ...
    return {
      avatarUrl: (
        <img
          ...
          src="src/assets/icons/notification/ic-notification-package.svg"
        />
      ),
      title,
    };
  ...
  if (notification.type === 'order-shipped') {
    return {
      avatarUrl: (
        <img
          alt={notification.title}
          src="src/assets/icons/notification/ic-notification-shipping.svg"
        />
      ),
      title,
    };
  ...
  if (notification.type === 'mail') {
    return {
      avatarUrl: (
        <img alt={notification.title} src="src/assets/icons/notification/ic-notification-mail.svg" />
      ),
      title,
    };
  }
  if (notification.type === 'chat-message') {
    return {
      avatarUrl: (
        <img alt={notification.title} src="src/assets/icons/notification/ic-notification-chat.svg" />
      ),
      title,
    };
  }
